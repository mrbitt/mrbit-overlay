...
MY_MINOR_VERSION="$(get_version_component_range 1-8)"
MY_BUILD="14067"

DESCRIPTION="Freeware advanced editor for dynamic and Web languages"
HOMEPAGE="http://www.activestate.com/products/komodo_edit"
SRC_URI="x86?   ( http://downloads.activestate.com/Komodo/releases/${MY_MINOR_VERSION}/Komodo-Edit-${PV}-${MY_BUILD}-linux-x86.tar.gz    )
         amd64? ( http://downloads.activestate.com/Komodo/releases/${MY_MINOR_VERSION}/Komodo-Edit-${PV}-${MY_BUILD}-linux-x86_64.tar.gz )"
