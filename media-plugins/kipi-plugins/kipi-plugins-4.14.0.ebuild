...
COMMONDEPEND="
	...
	media-libs/tiff:0
	virtual/jpeg:0
	calendar? ( kde-apps/kdepimlibs:4 )
...
kde4-base_src_compile() {
        sed "1s|-lQtCore| |" -i ${WORKDIR}/${P}_build/debianscreenshots/CMakeFiles/kipiplugin_debianscreenshots.dir/link.txt || die "sed failed"
	sed "1s|-lQtCore| |" -i ${WORKDIR}/${P}_build/facebook/CMakeFiles/kipiplugin_facebook.dir/link.txt || die "sed failed"
	sed "1s|-lQtCore| |" -i ${WORKDIR}/${P}_build/imgurexport/CMakeFiles/kipiplugin_imgurexport.dir/link.txt || die "sed failed"
	sed "1s|-lQtCore| |" -i ${WORKDIR}/${P}_build/googleservices/CMakeFiles/kipiplugin_googleservices.dir/link.txt || die "sed failed"
	sed "1s|-lQtCore| |" -i ${WORKDIR}/${P}_build/dropbox/CMakeFiles/kipiplugin_dropbox.dir/link.txt || die "sed failed"
