...
SRC_URI="http://ftp.gnome.org/pub/GNOME/sources/ocrfeeder/0.8/${P}.tar.xz"
...
src_prepare() {
	...
	epatch ${FILESDIR}/${PN}-${PV}-pyodf-unbundle.patch
	rm -rf src/ocrfeeder/odf/ || die
	
	# PIL hash collision 3
	#epatch ${FILESDIR}/${PN}-${PN}-fix-PIL-hashcollision.patch
