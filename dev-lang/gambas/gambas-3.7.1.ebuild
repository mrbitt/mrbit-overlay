...
IUSE="+curl +net +qt4 +x11 +sdl-sound +image-io +qt4-openg +odbc +sdl2 
	bzip2 +cairo crypt dbus +examples +gmp gnome +gsl gstreamer +gtk2 gtk3 httpd +image-imlib +image-io jit +libxml mime
	+mysql +ncurses odbc openal +opengl openssl pcre +pdf pop3 postgres +qt4-opengl +qt4-webkit +sdl sdl-sound sqlite v4l +xml +zlib"
