...
COMMIT="0d5ccf640db9ab80c975963780c3af97588c5c73"
MY_PN="${PN/_/-}"
...
pkg_postinst() {
	local _new_loader='3.4.0_p20170502'
	local _v
	for _v in ${REPLACING_VERSIONS}; do
		if ! version_is_at_least ${_new_loader} ${v}; then
			...
			elog ""
			elog "Since version 3.4.0_p20170502 ${PN} no longer loads modules on its own"
