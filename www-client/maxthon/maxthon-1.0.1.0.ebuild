...
SRC_URI="${SRC_URI}
	amd64? ( http://dl.maxthon.cn/linux/deb/packages/amd64/maxthon-browser-beta_${PV}_amd64.deb )
	x86? ( http://dl.maxthon.cn/linux/deb/packages/i386/maxthon-browser-beta_${PV}_i386.deb )"		  
