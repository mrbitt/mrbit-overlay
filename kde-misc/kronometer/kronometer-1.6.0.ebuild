...
HOMEPAGE="http://opendesktop.org/content/show.php/Kronometer?content=162829"
#SRC_URI="https://github.com/elvisangelaccio/${PN}/archive/${PV}.tar.gz -> ${P}.tar.gz"
#SRC_URI="http://www.aelog.org/files/${PN}/${P}.tar.gz"
SRC_URI="http://download.kde.org/stable/${PN}/${PV}/src/${P}.tar.xz"
