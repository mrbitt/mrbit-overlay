...
MY_PN="peazip"
MY_P="${MY_PN}-${PV}"
[[ ${PN} = *-gtk-bin ]] && SRC_URI="http://netcologne.dl.sourceforge.net/project/${MY_PN}/${PV}/${PN}-${PV}.LINUX.GTK2.tgz" || \
	SRC_URI="http://netcologne.dl.sourceforge.net/project/${MY_PN}/${PV}/${PN}-${PV}.LINUX.Qt.tgz"
