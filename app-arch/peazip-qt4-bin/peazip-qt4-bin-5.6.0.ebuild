...
MY_PN="peazip"
MY_P="${MY_PN}-${PV}"
[[ ${PN} = *-gtk-bin ]] && SRC_URI="http://downloads.sourceforge.net/project/${MY_P}/${PV}/${PN}-${PV}.LINUX.GTK2.tgz" || \
	SRC_URI="http://sourceforge.net/projects/${MY_PN}/files/${PV}/${MY_P}.LINUX.Qt.tgz"
...
MY_GTK_RDEPEND="!${CATEGORY}/${MY_PN}-qt4-bin
	amd64?  ( x11-libs/cairo[abi_x86_32]
