...
# $Header: /var/cvsroot/gentoo-x86/net-firewall/xtables-addons/xtables-addons-2.4.ebuild,v 1.3 2014/04/15 07:35:10 pacho Exp $
...
src_prepare() {
	...
	sed -e '/^all-local:/{s: modules::}' \
        ...
        epatch "${FILESDIR}/${P}-kernel-fix.patch"
